...
public class SudokuApplet extends JApplet {
  ...
  public void init() {
    ...
    this.setSize(sudokuField.getPreferredSize().width, sudokuField
  ...
  private void newStandardClassicSudoku(boolean generateGivens) {
  ...
  private void newStandardColorSudoku(boolean generateGivens) {
    final SudokuProperties properties = new SudokuProperties();
    properties.setDimensions(2);
    properties.setNumbers(9);
    List<Integer> dimension = new ArrayList<Integer>(2);
  ...
  private void newStandardXSudoku(boolean generateGivens) {
    final SudokuProperties properties = new SudokuProperties();
    properties.setDimensions(2);
    properties.setNumbers(9);
    List<Integer> dimension = new ArrayList<Integer>(2);
   ...
   */
  private void newSudoku(Sudoku sudoku, boolean generateGivens) {
...
private void cheat() {
  ...
  private void solve() {
    if (sudokuField != null) {
      List<SudokuValue> givens = sudokuField.exportValues();
      Sudoku sudoku = new Sudoku(sudokuField.getProperties());
      ...
      case 2:
        ...
        break;
      default:
        JOptionPane.showMessageDialog(this, "Invalid state (quickSolutions fault)!", "Not unique solution", JOptionPane.ERROR_MESSAGE);
        break;
      }
    }
  }
  ...
  private void solve(SudokuField solution) {
