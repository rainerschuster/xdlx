...
public abstract class Value<C> {
    ...
    public abstract boolean inRelation(final C columnValue);
     ...
     */
    public int relationColor(final C columnValue) {
        return 0;
    }
    ...
    /**
     * @param dlData
     *            The {@linkDancingLinksData} object that holds the data
     *            (this value is part of it).
     * @return List of columns that are in relation to this value, even if they
     *         are already covered!
     */
    /*public List<Column<C, V>> inRelations(final DancingLinksData<C, Value<C>> dlData) {
