...
public class DancingLinksData<C, V extends Value<C>> implements Iterable<Column<C, V>> {
  ...
  /** The primary columns generated by the {@link com.rainerschuster.dlx.DataGenerator}. */
  private List<C> generatedPrimaryColumns;

  /** The secondary columns generated by the {@link com.rainerschuster.dlx.DataGenerator}. */
  ...
  public void setRoot(Column<C, V> root) {
    this.root = root;
  }

  public void addPrimaryColumn(C columnValue) {
    addXColumn(columnValue, true);
    finalizePrimaryColumns();
  }

  public void addSecondaryColumn(C columnValue) {
    addXColumn(columnValue, false);
  }

  public void addAllPrimaryColumns(List<C> columnValues) {
  ...
  public void addAllSecondaryColumns(List<C> columnValues) {
  ...
  private void addXColumn(C columnValue, boolean primary) {
    Column<C, V> column = new Column<C, V>();
   ...
   *         can't be found
   */
  public Column<C, V> getColumn(C columnValue) {
    ...
    System.err.println("Error in getColumn: Column \"" + columnValue + "\" not found");
    return null;
  }
   ...
   */
  public static <C, V extends Value<C>> void printRow(Node<C, V> p) {
    Node<C, V> q = p;
    int k;
    do {
