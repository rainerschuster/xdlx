...
public class Queens {
  ...
  /**
   * @param args Command line arguments. Contains the number of queens.
   */
  ...
  public void start() {
    ...
    DancingLinksData<QueensColumnValue, QueensValue> dlData = generator.generate();
    ...
    dl.addSolutionListener(new SolutionListener<QueensColumnValue, QueensValue>(){
      ...
      public void onSolution(int count, int level, List<Node<QueensColumnValue, QueensValue>> solution) {
