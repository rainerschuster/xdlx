...
public class ViewProperties {
  ...
  /*private Color[] colors = new Color[] {
          ...
          Color.PINK,     Color.CYAN,         Color.RED,
          Color.MAGENTA,  Color.LIGHT_GRAY,   Color.YELLOW
  };*/

  /*public final static Color[] colors = new Color[]{
      new Color(153, 153, 204), new Color(153, 153, 204), new Color(204, 153, 179),
      new Color(153, 153, 204), new Color(153, 153, 204), new Color(153, 153, 204),
      new Color(153, 204, 179), new Color(153, 153, 204), new Color(204, 204, 153)
  };*/
